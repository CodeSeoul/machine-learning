...
from preprocess import get_cifar_dataloader
...
train_dataloader = get_cifar_dataloader(batch_size, is_training_dataset=True)
test_dataloader = get_cifar_dataloader(batch_size, is_training_dataset=False)
...
# Print model to get outputs
print(model)
# last FC layer shape is 512, number of classes is 10
